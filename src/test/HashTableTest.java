...
class HashTableTest {
	...
	void testHashTable()
	{
		...
		personproof.setDocument("1088034925");
		personproof.setName("JhonSanpedro");
		personproof.setPhone("3102800503");
		int expectedValue = 0;
	...
	void testInsertElement()
	{
		...
		// Step 3. Obtain the actual value
		Person[] actualValue = testedHash.insertElement("1088034925", "JhonSanpedro", "3102800503");
		// Step 4. Compare the expected versus actual values
	...
	void testSearchElementbyPosition()
	{
		...
		// Step 3. Obtain the actual value
		testedHash.insertElement("1088034925", "JhonSanpedro", "3102800503");
	...
	void testSearchElementbyValue()
	{
		...
		// Step 3. Obtain the actual value
		testedHash.insertElement("1088034925", "JhonSanpedro", "3102800503");
		Person actualValue = testedHash.searchElementbyValue("1088034925");
		// Step 4. Compare the expected versus actual values
		assertEquals2(expectedValue, actualValue);
	}
	...
	void testListElement()
	{
		...
		personproof.setPhone("3102800503");
		// Step 3. Obtain the actual value
		Person[] oldValue = testedHash.insertElement("1088034925", "JhonSanpedro", "3102800503");
	...
	void testUpdatetElement()
	{
		...
		// Step 3. Obtain the actual value
		testedHash.insertElement("1088034925", "JhonSanpedro", "3102800503");
		Person[] actualValue = testedHash.updateElement("1088034925", "JhonSanpedro", "3102800503");
		// Step 4. Compare the expected versus actual values
