...
public class QueueTest {
	...
	public void deQueueTest() {
		...
		testedQueue.enQueue(dato2);
		testedQueue.enQueue(dato3);
		testedQueue.enQueue(newDato);

		boolean actualValue = testedQueue.deQueue();
		// Step 4. Compare the expected versus actual values
		assertEquals(expectedValue, actualValue);
	}
	...
	public void listQueueTest() {
		...
		Queue testedQueue = new Queue();
		// Step 2. Create the expected value variable
		String expectedValue = "JuanElizabethCarlosJose";
		// Step 3. Obtain the actual value
		Person dato = new Person();
		dato.setDocument("1225090354");
		dato.setName("Juan");
		...
		String actualValue = testedQueue.listQueue();
		// Step 4. Compare the expected versus actual values
		assertEquals(expectedValue, actualValue);
	}
