...
class HashTableTest {
	...
	void testinsertElement() {
		...
		Person[] actualValue =testedHashTable.insertElement(Person1, Person1.getDocumento());
	...
	void testsearchElementByValue() {
		...
		expectedValue[7] = Person1;
		testedHashTable.insertElement(Person1, Person1.getDocumento());
		Person[] actualValue = testedHashTable.searchElementByValue(Person1.getDocumento());	
		assertArrayEquals(expectedValue, actualValue);
	}
	@Test
	void testupdateElement() {
		...
		testedHashTable.insertElement(Person1, Person1.getDocumento());
		Person[] actualValue = testedHashTable.updateElement(Person2, Person2.getDocumento());		
		assertArrayEquals(expectedValue, actualValue);
	}
	@Test
		...
		testedHashTable.insertElement(Person1, Person1.getDocumento());
		Person[] actualValue = testedHashTable.deleteElements(Person1.getDocumento());		
		assertArrayEquals(expectedValue, actualValue);
	}
