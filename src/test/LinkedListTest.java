...
class LinkedListTest {
	...
	void testListElements()
	{
		...
		String expl = "N° 1- Aerosmith, index01, Amazing, 004\n"
				+ "N° 2- Iron Maiden, index02, Flight of icarus, 001\n"
				+ "N° 3- Metallica, index03, Ride the lightning, 002\n";
	...
	void testDeletebyName()
	{
		...
		myList.deletebyName("Ride the lightning");
		assertEquals(2, myList.getSize());

		Mp3 nextSong = myList.getAt(1);

		assertEquals(author2, nextSong.getAuthor());
		assertEquals(file2, nextSong.getFile());
		assertEquals(name2, nextSong.getName());
		assertEquals(trackNo2, nextSong.getTrackNo());
	}
