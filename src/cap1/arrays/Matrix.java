...
public class Matrix {
	...
	// constructor asginar los valores de los atributos para construir un objeto de
	// tipo matriz
	public Matrix(int numeroFilas, int numeroColumnas) {

		this.numeroFilas = numeroFilas; // la primera variable es el atributo de la clase y la segunda variable es el
										// valor que recibe el constructor
