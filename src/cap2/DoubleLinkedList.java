...
public class DoubleLinkedList {
	...
	//CRUD	
	public void insertaPorCola(DoubleLinkNode Node) {

		// Step 1. create the new node
		DoubleLinkNode newNode = Node;
		// If the head is null
		if (this.head == null) {
	...
	public void insertaPorCabeza(DoubleLinkNode Node) {
	...
	//------------------------------------------
	public void insertaOrdenado(DoubleLinkNode Node) {
		String mayor="";
		// Step 1. create the new node
		DoubleLinkNode newNode = Node;
		// If the head is null
		if (this.head == null) {
			...
			if( Integer.parseInt(Node.getDato().getTrackNo()) > Integer.parseInt(cursor.getDato().getTrackNo()) ){
				mayor="SI";
			}else{mayor="NO";}
